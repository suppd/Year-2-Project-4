// GENERATED AUTOMATICALLY FROM 'Assets/Controls/UI_Controls.inputactions'
...
public class @UI_Controls : IInputActionCollection, IDisposable
{
    ...
    public struct PlayerActions
    {
        ...
        public PlayerActions(@UI_Controls wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @UI_Controls m_Wrapper;
        public UIActions(@UI_Controls wrapper) { m_Wrapper = wrapper; }
